...
#else
inline const uint8_t FreeSans12pt7bBitmaps[] PROGMEM = {
...
inline const GFXglyph FreeSans12pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 6, 0, 1},         // 0x20 ' '
    {0, 2, 18, 8, 3, -17},      // 0x21 '!'
    {5, 6, 6, 8, 1, -16},       // 0x22 '"'
...
inline const GFXfont FreeSans12pt7b PROGMEM = {(uint8_t *)FreeSans12pt7bBitmaps,
