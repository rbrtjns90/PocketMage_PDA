...
#else
inline const uint8_t FreeSans9pt7bBitmaps[] PROGMEM = {
...
inline const GFXglyph FreeSans9pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 5, 0, 1},        // 0x20 ' '
    {0, 2, 13, 6, 2, -12},     // 0x21 '!'
    {4, 5, 4, 6, 1, -12},      // 0x22 '"'
...
inline const GFXfont FreeSans9pt7b PROGMEM = {(uint8_t *)FreeSans9pt7bBitmaps,
