...
#else
inline const uint8_t FreeMono9pt7bBitmaps[] PROGMEM = {
...
inline const GFXglyph FreeMono9pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 11, 0, 1},      // 0x20 ' '
    {0, 2, 11, 11, 4, -10},   // 0x21 '!'
    {3, 6, 5, 11, 2, -10},    // 0x22 '"'
    {7, 7, 12, 11, 2, -10},   // 0x23 '#'
...
inline const GFXfont FreeMono9pt7b PROGMEM = {(uint8_t *)FreeMono9pt7bBitmaps,
