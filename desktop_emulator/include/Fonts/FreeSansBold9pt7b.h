...
#else
inline const uint8_t FreeSansBold9pt7bBitmaps[] PROGMEM = {
...
inline const GFXglyph FreeSansBold9pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 5, 0, 1},        // 0x20 ' '
    {0, 3, 13, 6, 2, -12},     // 0x21 '!'
    {5, 7, 5, 9, 1, -12},      // 0x22 '"'
...
inline const GFXfont FreeSansBold9pt7b PROGMEM = {(uint8_t *)FreeSansBold9pt7bBitmaps,
